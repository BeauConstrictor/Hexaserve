## https://github.com/PMunch/nim-cache/blob/master/src/cache.nim
## This file is PMunch's nim-cache a fast, efficient caching LRU and LRF cache
## module for Nim. I have pasted it here so that it doesn't need to be installed
## separately from Nimble.
